...
def get_embedding_data(embeddings_dir):
  try:
    tr_episodes = load_npy(os.path.join(embeddings_dir, "clip_embeddings_train.npz"))
    tr_labels = load_npy(os.path.join(embeddings_dir, "clip_labels_train.npz"))
    val_episodes = load_npy(os.path.join(embeddings_dir, "clip_embeddings_val.npz"))
    val_labels = load_npy(os.path.join(embeddings_dir, "clip_labels_val.npz"))
    test_episodes = load_npy(os.path.join(embeddings_dir, "clip_embeddings_test.npz"))
    test_labels =load_npy(os.path.join(embeddings_dir, "clip_labels_test.npz"))
